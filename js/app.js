(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-oportunity-01")) new core(".slider-oportunity-01", {
            ...
            speed: 600,
            pagination: {
                el: ".item-oportunity__dotts-01",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-arrow-01_prev",
                nextEl: ".slider-arrow-01_next"
            },
            on: {}
        });
        if (document.querySelector(".slider-oportunity-02")) new core(".slider-oportunity-02", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 600,
            pagination: {
                el: ".item-oportunity__dotts-02",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-arrow-02_prev",
                nextEl: ".slider-arrow-02_next"
            },
            on: {}
        });
        if (document.querySelector(".slider-oportunity-03")) new core(".slider-oportunity-03", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 600,
            pagination: {
                el: ".item-oportunity__dotts-03",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-arrow-03_prev",
                nextEl: ".slider-arrow-03_next"
            },
            on: {}
        });
        if (document.querySelector(".slider-oportunity-04")) new core(".slider-oportunity-04", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 600,
            pagination: {
                el: ".item-oportunity__dotts-04",
                clickable: true
            },
            navigation: {
                prevEl: ".slider-arrow-04_prev",
                nextEl: ".slider-arrow-04_next"
            },
            on: {}
        });
        if (document.querySelector(".cards-personal__slider")) new core(".cards-personal__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            ...
            grabCursor: true,
            navigation: {
                prevEl: ".cards-personal-arrow_prev",
                nextEl: ".cards-personal-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1
